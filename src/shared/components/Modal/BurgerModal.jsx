...
import s from './styles/burger-modal.module.scss'
import ds from './styles/modal-default.module.scss'

export const BurgerModal = ({ isOpen, setIsOpen, children, className }) => {
	...
	return (
		<Portal>
			<div className={cn(ds.modal, { [s.active]: isAnimating })}>
				...
				<div className={cn(s.burger, { [s.active]: isAnimating }, className)}>
