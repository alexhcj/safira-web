...
export const ResetPasswordStepperFormEmail = ({ type, isLoading, onSubmit }) => {
	...
	return (
		<form className={s.form} onSubmit={handleSubmit}>
			<p className={s.text}>Enter profile email address and we’ll send to it a reset password link.</p>
			<Input
